 ...
 * This action enables the selected Vimeo players to work with the Vimeo Player SDK.
 *
 * @param {Object} settings The settings object.
 * @param {Object} event The underlying event object that triggered the rule.
 */
module.exports = function(settings, event) {
  logger.debug('Enabling Vimeo playback tracking on ' + event.$type);
  vimeoPlayerSdk.enableVideoPlaybackTracking(settings);
};
