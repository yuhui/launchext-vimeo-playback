...
var VIDEO_DATA_NAME = 'playerAutopaused';

/**
 * Player Autopaused data element.
 * This data element returns the autopause state of the player.
 *
 ...
 *
 * @returns {Boolean} `true` if the player's state is autopaused, `false` otherwise.
 */
