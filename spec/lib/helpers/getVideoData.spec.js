...
const VIDEO_DATA_NAMES = {
  ...
  'errorMethod': ['player error'],
  'errorName': ['player error'],
  'playerAutopaused': [],
  'playerColour': [],
  'playerState': [],
  'videoCurrentTime': [],
...
describe('getVideoData helper delegate', () => {
  ...
  describe('with invalid arguments', () => {
    ...
    it(
      'logs an error message when "event.$type" property does not start with "vimeo-playback."',
      () => {
        this.event.$type = 'foo';
        const result = this.helperDelegate(this.videoDataName, this.event);
    ...
    it(
      'logs an error message when "event.vimeo" property is missing',
      () => {
    ...
    it(
      'logs an error message when "event.vimeo.playerState" property is missing',
      () => {
        delete this.event.vimeo.playerState;
        const result = this.helperDelegate(this.videoDataName, this.event);
